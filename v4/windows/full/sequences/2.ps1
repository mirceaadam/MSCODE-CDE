...
" "
#REBOOT FLAG
# Check if reboot was performed
$rebootPending = Get-ItemProperty -Path "HKCU:\Software\MyApp" -Name "RebootPending" -ErrorAction SilentlyContinue

if ($rebootPending -eq $null) {
    ...
    # Reboot was performed, continue with the remaining installations
    Write-Host "Reboot performed. Continuing with installations."
    # Add your installation steps here
}

# Remove the registry key to indicate that the reboot has been processed
Remove-ItemProperty -Path "HKCU:\Software\MyApp" -Name "RebootPending" -ErrorAction SilentlyContinue
